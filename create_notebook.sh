...
# Create a Jupyter notebook for 2048 RL Agent
cat > 2048_RL_Agent.ipynb << 'EOL'
{
 "cells": [
  {
   "cell_type": "markdown",
...
echo "Script created successfully. Run ./create_notebook.sh to generate the Jupyter notebook." 